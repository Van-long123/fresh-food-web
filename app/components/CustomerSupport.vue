            ...
            >
              <div class="field-group">
                <label class="field-label"
                  >Loại yêu cầu <span class="req">*</span></label
                >
                <Select
                  v-model="form.type"
                  ...
                  class="w-full"
                />
                <small v-if="errors.type" class="field-err">{{
                  errors.type
                }}</small>
              </div>
              ...
              <div class="field-row">
                <div class="field-group">
                  ...
                  <small v-if="errors.name" class="field-err">{{
                    errors.name
                  }}</small>
                </div>
                <div class="field-group">
                  ...
                  <small v-if="errors.phone" class="field-err">{{
                    errors.phone
                  }}</small>
                </div>
              </div>
              ...
              <div class="field-row">
                <div class="field-group">
                  ...
                  <small v-if="errors.email" class="field-err">{{
                    errors.email
                  }}</small>
                </div>
                <div class="field-group">
                  <label class="field-label"
                    >Mã đơn hàng <span class="opt">(tuỳ chọn)</span></label
                  >
                  <div class="input-wrap">
              ...
              <div class="field-group">
                <label class="field-label"
                  >Nội dung yêu cầu <span class="req">*</span></label
                >
                <Textarea
                ...
                />
                <small v-if="errors.message" class="field-err">{{
                  errors.message
                }}</small>
              </div>
              ...
              <div class="field-group">
                <label class="field-label"
                  >Đính kèm ảnh <span class="opt">(tuỳ chọn)</span></label
                >
                <div
                  class="upload-box"
                ...
                >
                  ...
                  <p class="upload-text">
                    Kéo thả hoặc <span class="upload-link">chọn ảnh</span>
                  </p>
          ...
          <div class="info-col reveal" ref="infoRef">
            <div class="info-box">
              ...
              <div class="sla-box">
                ...
                <ul class="sla-list">
                  <li>
                    <span class="sla-check">✓</span> Phản hồi trong vòng 2 giờ
                    (8h–22h)
                  </li>
                  <li>
                    <span class="sla-check">✓</span> Giải quyết triệt để trong
                    24 giờ
                  </li>
                  <li>
                    <span class="sla-check">✓</span> Hoàn tiền 100% nếu lỗi từ
                    SmartFood
                  </li>
                </ul>
              </div>
