<template>
  <div class="min-h-screen bg-[#f5f5f5] pb-14 text-[#111827]">
    <div class="mx-auto max-w-7xl px-4 pt-4 md:px-6">
      ...
      <section
        class="category-banner reveal-up mt-3 rounded-2xl p-4 md:h-40 md:p-6"
      >
        <div class="flex h-full items-center justify-between gap-4">
          <div class="flex items-center gap-4">
            <div
              class="grid h-16 w-16 place-items-center rounded-2xl bg-white/20 text-4xl backdrop-blur"
            >
              {{ categoryIcon }}
            </div>
            <div>
              <h1 class="text-2xl font-black text-white md:text-[28px]">
                {{ categoryName }}
              </h1>
              <span
                class="mt-2 inline-flex rounded-full bg-white px-3 py-1 text-sm font-semibold text-[#f47f20]"
              >
          ...
          <div class="hidden md:block">
            <img
              :src="bannerImage"
              alt="Food"
              class="h-28 w-44 rounded-xl object-cover shadow-lg transition-transform duration-500"
