            ...
            <div class="space-y-4">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div class="flex flex-col gap-1">
                  ...
                  />
                  <small v-if="errors.full_name" class="text-red-500 text-xs mt-0.5">
                    {{ errors.full_name }}
                  </small>
                </div>
                ...
                <div class="flex flex-col gap-1">
                  ...
                  />
                  <small v-if="errors.phone" class="text-red-500 text-xs mt-0.5">
                    {{ errors.phone }}
                  </small>
                </div>
              </div>
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div class="flex flex-col gap-1">
                  ...
                  />
                  <small v-if="errors.province" class="text-red-500 text-xs mt-0.5">
                    {{ errors.province }}
                  </small>
                </div>
                ...
                <div class="flex flex-col gap-1">
                  ...
                  />
                  <small v-if="errors.district" class="text-red-500 text-xs mt-0.5">
                    {{ errors.district }}
                  </small>
                </div>
              </div>
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div class="flex flex-col gap-1">
                  ...
                  />
                  <small v-if="errors.ward" class="text-red-500 text-xs mt-0.5">
                    {{ errors.ward }}
                  </small>
                </div>
                ...
                <div class="flex flex-col gap-1">
                  ...
                  />
                  <small v-if="errors.address" class="text-red-500 text-xs mt-0.5">
                    {{ errors.address }}
                  </small>
                </div>
              </div>
              ...
              <div class="grid grid-cols-1 gap-4">
                <div class="flex flex-col gap-1">
                  ...
                  />
                  <small v-if="errors.note" class="text-red-500 text-xs mt-0.5">
                    {{ errors.note }}
                  </small>
                </div>
              </div>
    ...
    >
      ...
      <div class="p-5">
        ...
        <div class="space-y-3 max-h-80 overflow-y-auto pr-1">
          ...
          <!-- Empty state -->
          <div v-if="authStore.vouchers.length === 0" class="text-center py-8">
...
function validateAll(): boolean {
  (
    ["full_name", "phone", "province", "district", "ward", "address", "note"] as const
