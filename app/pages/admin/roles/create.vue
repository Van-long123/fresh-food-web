...
useHead({
  title: "Tạo vai trò - Quản trị SmartFood",
});
      ...
      <div class="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <p class="mt-1 text-sm text-slate-500 dark:text-slate-300">
            Thiết lập một nhóm quyền truy cập mới với phạm vi tùy chỉnh.
          </p>
        </div>
          ...
          <div class="grid gap-4 mt-4">
            <div>
              ...
              <InputText
                v-model="form.title"
                class="mt-2 w-full"
                placeholder="Ví dụ: Biên tập nội dung, Quản lý kho"
              />
            ...
            <div>
              ...
              <Textarea
                ...
                rows="3"
                class="mt-2 w-full"
                placeholder="Mô tả phạm vi chức năng của nhóm này..."
              />
