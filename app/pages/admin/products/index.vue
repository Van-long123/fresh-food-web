...
const products = [
  { id: 1, name: 'Education Dashboard', category: 'Html templates', technology: 'Angular', description: 'Start developing with an open-source library of over 450+ UI components...', price: '$2999', discount: 'No' },
  { id: 2, name: 'React Dashboard', category: 'Html templates', technology: 'React', description: 'Start developing with an open-source library of over 450+ UI components...', price: '$3999', discount: '10%' },
  // Add more as needed
]
</script>
          ...
          <nav class="flex mb-5" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
              <li class="inline-flex items-center">
                <NuxtLink :to="ROUTES.ADMIN.DASHBOARD" class="inline-flex items-center text-gray-700 hover:text-primary-600 dark:text-gray-300 dark:hover:text-white">
            ...
            <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
              <thead class="bg-gray-100 dark:bg-gray-700">
                <tr>
                  ...
                  <th scope="col" class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">Technology</th>
                  ...
                  <th scope="col" class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">Discount</th>
