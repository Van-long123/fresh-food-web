...
useHead({
  title: "Chỉnh sửa mã giảm giá - Quản trị SmartFood",
});
  ...
  <div class="px-4 pt-6 space-y-6">
    ...
    >
      ...
      <p class="text-sm text-red-600 dark:text-red-400 mt-2">
        Mã giảm giá bạn đang chỉnh sửa không tồn tại hoặc đã bị xóa.
      </p>
      <button
        class="mt-4 rounded-full bg-red-600 px-4 py-2 text-sm font-semibold text-white hover:bg-red-700"
        @click="router.push(ROUTES.ADMIN.VOUCHERS)"
      >
        ...
        <div class="flex flex-wrap items-start justify-between gap-4">
          <div>
            ...
            <p class="mt-1 text-sm text-slate-500 dark:text-slate-300">
              Thiết lập lại các tham số cho mã coupon {{ form.code }}.
            </p>
          </div>
          ...
          >
            ...
            <div class="grid gap-4 mt-4 md:grid-cols-2">
              <div>
                ...
                <InputText
                  v-model="form.code"
                  class="mt-2 w-full font-mono uppercase"
                />
